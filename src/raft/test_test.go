...
func TestReElection2A(t *testing.T) {
  ...
  fmt.Printf("----------------- Raft %d is disconnect ------------------- \n", leader1)
	cfg.checkOneLeader()
	...
	cfg.connect(leader1)
  fmt.Printf("----------------- Raft %d is reconnect ------------------- \n", leader1)
  ...
  fmt.Printf("----------------- Raft %d and Raft %d is disconnect ------------------- \n", leader2, (leader2 + 1) % servers)
...
func TestManyElections2A(t *testing.T) {
	...
	for ii := 1; ii < iters; ii++ {
		...
		cfg.disconnect(i2)
		cfg.disconnect(i3)
    fmt.Printf("------------------disconnect raft %d, raft %d and raft %d ---------------- \n", i1, i2, i3)
		...
		cfg.connect(i2)
		cfg.connect(i3)
    fmt.Printf("------------------reconnect raft %d, raft %d and raft %d ---------------- \n", i1, i2, i3)
	}
